module.exports = [
  {
    id: 'zesty-one-pot-chicken-bake',
    name: 'Zesty One-Pot Chicken Bake',
    desc: `We love chicken. We also love doing less dishes. So any time we can make a one pot chicken dinner, it's chalked up as a win.`,
    serving: 4,
    fact: {
      energy: 1469,
      sodium: 500,
  ...
  },
  {
    ...
    ingredents: [  
      ...
      {
        name: 'Salt and cinnamon to taste',
        amount: null,
        unit: null,
      },
    ],
  ...
  },
  {
    ...
    ingredents: [  
      {
        name: 'Salt(Steak seasoning)',
        amount: 3/2,
        unit: 'tsp',
      },
      {
        name: 'Pepper(Steak seasoning)',
        amount: 3/2,
        unit: 'tsp',
      },
      {
        name: 'Garlic powder(Steak seasoning)',
        amount: 1,
        unit: 'tsp',
      },
      {
        name: 'Paprika(Steak seasoning)',
        amount: 1,
        unit: 'tsp',
      },
      {
        name: 'Onion powder(Steak seasoning)',
        amount: 1,
        unit: 'tsp',
      },
      {
  ...
  },
  {
    ...
    ingredents: [  
      ...
      {
        name: 'Shreded sharp cheddar cheese',
        amount: 1/2,
        unit: 'cup',
      },
      {
